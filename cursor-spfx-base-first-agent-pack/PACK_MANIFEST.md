...
- AGENTS.md: root agent instruction
- PROJECT_CONTEXT.md: factual project notes to fill in
- .cursor/rules/00-base-first.mdc
- .cursor/rules/10-no-domain-invention.mdc
